...
{  
  ...
  counterFile.open("stepCount.txt",ios::app);
  ...
  do
  {
    ...
    while (gameOver == false)
	{
	 ...
	 if (chipsInPile == 0)
	 {
        ...
        counterFile << FindPlayerName(playerNames, player1Turn) << " won in " << stepCounter << " steps." ;
	 }
 	}
...
int askMove(bool player1Turn, int chipsInPile, string names[])
{
    ...
    int takeCounter=0;
    ofstream resultFile;
    resultFile.open("resFileCounter.txt",ios::app);
	do
     {	
